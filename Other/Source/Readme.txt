...
user in an INI file next to MongoDBCompassPortable.exe called MongoDBCompassPortable.ini.
...
copy AppNamePortable.ini from this directory to MongoDBCompassPortable.ini next to
MongoDBCompassPortable.exe. The options in the INI file are as follows:
